...
def future_result(day,month,year):
    ...
    diction_prediction_future=[rf_data[0],data.trainer(rf_data[0],svm_data[0])]
    ...
    return [rf_data[0],data.trainer(rf_data[0],svm_data[0]),rf_data[1],svm_data[1],maximum_score,string_result,algorithms,day,month,year]
