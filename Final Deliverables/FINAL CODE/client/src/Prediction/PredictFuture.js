      ...
      <div class="bg-img-login bg-img-future">
        <div class="future-container register-container">
          <form>
            ...
            <br></br>
            <input class="gray-background" type="number" min="0" step="1" onKeyDown={blockInvalidChar} placeholder='Day' onChange={(e)=>{
              setDay(e.target.value)
            }} required />
            <br></br>
            <label>Enter month</label>
            <br></br>
            <input class="gray-background" type="number" min="0" max="2022" step="1" onKeyDown={blockInvalidChar} placeholder='Month' onChange={(e)=>{
              setMonth(e.target.value)
            }} required />
            <br></br>
            <label>Enter year</label>
            <br></br>
            <input class="gray-background" type="number" min="0" max="2022" step="1" onKeyDown={blockInvalidChar} placeholder='Year' onChange={(e)=>{
