      ...
      <div class="bg-img bg-img-login">
        <div class="register-container">
          <form>
            ...
            <br></br>
            <input class="gray-background" type="text" placeholder='Name' onChange={(e)=>{
              setFirstName(e.target.value)
            }} required />
            <br></br>
            <label>Last Name</label>
            <br></br>
            <input class="gray-background" type="text" placeholder='Last name' onChange={(e)=>{
              setLastName(e.target.value)
            }} required />
            <br></br>
            <label>Username</label>
            <br></br>
            <input class="gray-background" type="text" placeholder='Username' onChange={(e)=>{
            ...
            <br></br>
            <input class="gray-background" type={passwordShown ? "text" : "password"} placeholder='Password'  onChange={(e)=>{
            ...
            <br></br>
            <input class="gray-background" type={passwordShown ? "text" : "password"} placeholder='Re-type password' onChange={(e)=>{
